...
impl CommandType {
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::WorkflowUpdateGraph => "workflow.update_graph",
            ...
            Self::WorkflowRunSaveInputOverrides => "workflow.run.save_input_overrides",
            Self::WorkflowRunConfirmInput => "workflow.run.confirm_input",
            Self::WorkflowRunPause => "workflow.run.pause",
            Self::WorkflowRunResume => "workflow.run.resume",
            Self::WorkflowRunApplyGraphPatch => "workflow.run.apply_graph_patch",
            Self::WorkflowConfirmProposal => "workflow.confirm_proposal",
